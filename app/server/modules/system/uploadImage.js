        ...
        fs.readFile(req.files.inputImg.path, function (err, data) {
            ...
            if (err) {
                ...
                fs.writeFile(newPath, data, function (err) { 
                    ...
                    var newContent = req.session.user.site.blocks[req.param("blockIndex")].content;
                    newContent.img = 'userContent/' + req.session.user.user + 
                                     '/img/' + req.files.inputImg.name;
                    req.session.user.site.blocks[req.param("blockIndex")].content = newContent;
