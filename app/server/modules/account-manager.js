...
var dbPort 		= 33828;
var dbHost 		= 'ds033828.mongolab.com';
var dbName 		= 'better';
var user      = 'belfordz';
var password  = '2381632hockey';
...
db.open(function(e, d) {
    if (e) {
        ...
        db.authenticate(user, password, function(e, res) {
            if (!res)
                console.log('Failed to Auth with mongodb :: ' + e);
        });
    }
});
...
exports.getUserObjectFromSiteName = function(site, callback) {
    accounts.findOne({siteName:site}, function(e, o) {
        if(o) {
            ...
            console.log('site name lookup failed with: ' + e);
            callback(null);
        }
    });
}
...
exports.manualLogin = function(user, pass, callback) {
    accounts.findOne({user:user}, function(e, o) {
        if (o == null) {
            console.log("manual Login Failed" + o);
        ...
        if (o) {
            ...
            accounts.findOne({email:newData.email}, function(e, o) {
                if (o) {
                    ...
                    console.log("adding account with password: " + newData.pass);
...
var validatePassword = function(plainPass, hashedPass, callback) {
    console.log("attempted login with pass: " + plainPass);
